...
- (void)layoutSubviews {
    ...
    CGFloat originX, originY, originW, originH;
    originX = cellInsetWidth;
    originY = self.contentView.frame.origin.y;
    originH = self.contentView.frame.size.height;
    originW = self.contentView.frame.size.width;
    
    [mainView setFrame:CGRectMake(originX, originY, originW, originH)];
