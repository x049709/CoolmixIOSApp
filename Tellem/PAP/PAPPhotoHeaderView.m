...
- (id)initWithFrame:(CGRect)frame buttons:(PAPPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        ...
        // translucent portion
        self.containerView = [[UIView alloc] initWithFrame:CGRectMake( 2.0f, 0.0f, self.bounds.size.width - 4.0f, self.bounds.size.height)];
        [self addSubview:self.containerView];
        [self.containerView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"whiteBackgroundComments.png"]]];
        //[self.containerView setBackgroundColor:[UIColor grayColor]];
        
        self.avatarImageView = [[PAPProfileImageView alloc] init];
        self.avatarImageView.frame = CGRectMake( 4.0f, 4.0f, 50.0f, 50.0f);
        ...
        if (self.buttons & PAPPhotoHeaderButtonsUser) {
            ...
            UIFont *nameFont = [UIFont fontWithName:kFontBold size:14];
            [[self.userButton titleLabel] setFont:nameFont];
        ...
        // timestamp
        self.timestampLabel = [[UILabel alloc] initWithFrame:CGRectMake( 55.0f, 24.0f, containerView.bounds.size.width - 50.0f - 72.0f, 18.0f)];
        ...
        UIFont *timeFont = [UIFont fontWithName:kFontBold size:12];
        [self.timestampLabel setFont:timeFont];
...
- (void)setPhoto:(PFObject *)aPhoto {
    ...
    PFFile *profilePictureSmall = [user objectForKey:@"profilePictureMedium"];
    ...
    CGPoint userButtonPoint = CGPointMake(55.0f, 6.0f);
