...
@synthesize commentTextField,photoFile,thumbnailFile,photoPostBackgroundTaskId,fileUploadBackgroundTaskId,postBtn,postPhoto,docFile;
...
-(void)addPostPhotoButton
{
    ...
    [self.postPhoto setFrame:CGRectMake(20, 20, 56, 56)];
    ...
    [self.postScrollView addSubview:self.postPhoto];
}
