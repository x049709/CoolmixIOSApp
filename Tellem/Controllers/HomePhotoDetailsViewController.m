...
@interface HomePhotoDetailsViewController ()
{
...
@implementation HomePhotoDetailsViewController
...
-(void) notifyCircleOfPostingwithComment: (PFObject *) comment {
    ...
    if (membersToNotify.count > 0) {
        NSString *message = [NSString stringWithFormat:@"%@ posted to @%@!", user[@"displayName"],[self.pageCircle valueForKey:kPAPCircleNameKey]];
