//
//  CircleActivitiesViewController.h
//  Tellem
//
...
@interface CircleActivitiesViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate>{
