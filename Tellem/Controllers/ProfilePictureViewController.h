...
@interface ProfilePictureViewController : UIViewController<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate, UIScrollViewDelegate,FHSTwitterEngineAccessTokenDelegate,UITableViewDelegate,UITextViewDelegate,CLLocationManagerDelegate,UIActionSheetDelegate,UIDocumentInteractionControllerDelegate, PostCirclesSendDataProtocol>
{
