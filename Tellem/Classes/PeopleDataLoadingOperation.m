...
const NSTimeInterval PeopleDataLoadingOperationDuration = 0.3;

@implementation PeopleDataLoadingOperation
    ...
    */
    ...
    if (self) {
        ...
        [self addExecutionBlock:^{
            ...
            dataPage = [TellemUtility getSearchResults:tM.gCurrentSearchText andIndexSet:indexes];
