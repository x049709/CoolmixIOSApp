...
#import "CoolmixUtility.h"
#import "PAPUtility.h"

@implementation CoolmixUtility {}
...
+ (NSArray*) getCoolmixGSR: (NSIndexSet*) indexes andServerURL: (NSString *) serverURL andServerUser: (NSString*) serverUser andServerPassword: (NSString*) serverPassword
{
    //MWLogDebug(@"\nMixHomeViewController viewDidLoad started.");
    
    NSString *requestURL = [serverURL stringByAppendingString:@"/mixApi/gsr/"];
